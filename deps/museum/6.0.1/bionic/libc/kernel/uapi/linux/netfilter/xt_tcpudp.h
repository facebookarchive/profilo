...
#define XT_TCPUDP_H
#define XT_TCPUDP_H_
#define NDK_ANDROID_SUPPORT_XT_TCPUDP_H
#define NDK_ANDROID_SUPPORT_XT_TCPUDP_H_
#define NDK_ANDROID_SUPPORT_UAPI_XT_TCPUDP_H
#define NDK_ANDROID_SUPPORT_UAPI_XT_TCPUDP_H_
