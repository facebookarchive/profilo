...
#define NDK_ANDROID_SUPPORT_XT_NFQ_TARGET_H
#define NDK_ANDROID_SUPPORT_XT_NFQ_TARGET_H_
#define NDK_ANDROID_SUPPORT_UAPI_XT_NFQ_TARGET_H
#define NDK_ANDROID_SUPPORT_UAPI_XT_NFQ_TARGET_H_
