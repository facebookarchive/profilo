...
#define NDK_ANDROID_SUPPORT__LINUX_BRIDGE_EBT_AMONG_H
#define NDK_ANDROID_SUPPORT__LINUX_BRIDGE_EBT_AMONG_H_
#define NDK_ANDROID_SUPPORT_UAPI__LINUX_BRIDGE_EBT_AMONG_H
#define NDK_ANDROID_SUPPORT_UAPI__LINUX_BRIDGE_EBT_AMONG_H_
