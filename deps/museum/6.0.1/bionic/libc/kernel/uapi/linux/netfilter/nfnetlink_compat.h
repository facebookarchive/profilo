...
#define NDK_ANDROID_SUPPORT_NFNETLINK_COMPAT_H
#define NDK_ANDROID_SUPPORT_NFNETLINK_COMPAT_H_
#define NDK_ANDROID_SUPPORT_UAPI_NFNETLINK_COMPAT_H
#define NDK_ANDROID_SUPPORT_UAPI_NFNETLINK_COMPAT_H_
