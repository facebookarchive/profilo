...
#define UAPI_LINUX_UUID_H_
#define UAPI_LINUX_UUID_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_UUID_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_UUID_H
#define NDK_ANDROID_SUPPORT_LINUX_UUID_H_
#define NDK_ANDROID_SUPPORT_LINUX_UUID_H
#define _LINUX_UUID_H_
#define _LINUX_UUID_H
#define _UAPI_LINUX_UUID_H
