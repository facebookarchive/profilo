...
#define NDK_ANDROID_SUPPORT_LINUX_IF_HIPPI_H
#define NDK_ANDROID_SUPPORT_LINUX_IF_HIPPI_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_IF_HIPPI_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_IF_HIPPI_H_
