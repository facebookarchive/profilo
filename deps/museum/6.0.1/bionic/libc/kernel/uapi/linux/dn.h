...
#define LINUX_DN_H
#define LINUX_DN_H_
#define NDK_ANDROID_SUPPORT_LINUX_DN_H
#define NDK_ANDROID_SUPPORT_LINUX_DN_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_DN_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_DN_H_
#define _UAPI_LINUX_DN_H
#define _UAPI_LINUX_DN_H_
#define _LINUX_DN_H_
