...
#define NDK_ANDROID_SUPPORT_UAPI_ADFS_FS_H
#define NDK_ANDROID_SUPPORT_UAPI_ADFS_FS_H_
#define NDK_ANDROID_SUPPORT_ADFS_FS_H
#define NDK_ANDROID_SUPPORT_ADFS_FS_H_
#define _ADFS_FS_H
#define _ADFS_FS_H_
