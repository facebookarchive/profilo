...
#define NDK_ANDROID_SUPPORT__ASM_IOCTLS_H
#define NDK_ANDROID_SUPPORT__ASM_IOCTLS_H_
#define NDK_ANDROID_SUPPORT_UAPI__ASM_IOCTLS_H
#define NDK_ANDROID_SUPPORT_UAPI__ASM_IOCTLS_H_
