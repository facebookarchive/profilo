...
#include <museum/6.0.1/art/runtime/entrypoints/interpreter/interpreter_entrypoints.h>
#include <museum/6.0.1/art/runtime/entrypoints/jni/jni_entrypoints.h>
...
class Thread {
 ...
 public:
  ...
  // FB
  // Expose QuickEntryPoints
  QuickEntryPoints GetQuickEntryPoints() const {
    return tlsPtr_.quick_entrypoints;
  }
  // END FB
