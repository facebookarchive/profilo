...
// @generated SignedSource<<c925a55d5911f7aa60e4d16a5261b337>>
// @model md5 3267c66ca2719baf5a4f7c804db31e5e
...
namespace art {
  ...
  uint32_t StackMap::GetDexPc(CodeInfo const& p1) const {
    return
      ::facebook::museum::art::detail::lookup___ZNK3art8StackMap8GetDexPcERKNS_8CodeInfoE
      <uint32_t
...
namespace art {
  ...
  uint32_t StackMap::GetNativePcOffset(CodeInfo const& p1) const {
    return
      ::facebook::museum::art::detail::lookup___ZNK3art8StackMap17GetNativePcOffsetERKNS_8CodeInfoE
      <uint32_t
        (StackMap const*, CodeInfo const&)>()
      (this, p1);
  }
...
namespace art {
  ...
  size_t StackMap::ComputeStackMapSizeInternal(size_t p1, size_t p2, size_t p3, size_t p4, size_t p5, size_t p6)  {
    return *
      ::facebook::museum::art::detail::lookup___ZN3art8StackMap27ComputeStackMapSizeInternalEjjjjjj
      <size_t
        >()
      ;
  }
