...
#include <museum/6.0.1/libnativehelper/ScopedLocalRef.h>
...
struct VectorCounter {
    ...
    VectorCounter(const facebook::museum::MUSEUM_VERSION::std::vector<facebook::museum::MUSEUM_VERSION::std::string>& strings) : strings(strings) {}
    size_t operator()() {
        return strings.size();
    }
};
struct VectorGetter {
    const facebook::museum::MUSEUM_VERSION::std::vector<facebook::museum::MUSEUM_VERSION::std::string>& strings;
    VectorGetter(const facebook::museum::MUSEUM_VERSION::std::vector<facebook::museum::MUSEUM_VERSION::std::string>& strings) : strings(strings) {}
