...
class Instrumentation {
 ...
 private:
  ...
  // FB: InstrumentationLevelTable is bigger on our build than the platform's.
  // FB: Replace with a correctly sized array.
  char requested_instrumentation_levels_[12] GUARDED_BY(Locks::mutator_lock_);
  ...
  // FB: std::unordered_set is bigger on our build than the platform's.
  // FB: Replace with a correctly sized array.
  char deoptimized_methods_[20] GUARDED_BY(deoptimized_methods_lock_);
