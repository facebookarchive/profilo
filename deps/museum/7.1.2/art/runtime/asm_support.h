...
#include <museum/7.1.2/art/runtime/gc/allocator/rosalloc.h>
...
#include <museum/7.1.2/art/runtime/read_barrier_c.h>
...
ADD_TEST_EQ(static_cast<size_t>(STACK_REFERENCE_SIZE), sizeof(facebook::museum::MUSEUM_VERSION::art::StackReference<facebook::museum::MUSEUM_VERSION::art::mirror::Object>))

// Size of heap references
#define COMPRESSED_REFERENCE_SIZE 4
ADD_TEST_EQ(static_cast<size_t>(COMPRESSED_REFERENCE_SIZE),
            sizeof(facebook::museum::MUSEUM_VERSION::art::mirror::CompressedReference<facebook::museum::MUSEUM_VERSION::art::mirror::Object>))
...
ADD_TEST_EQ(static_cast<size_t>(RUNTIME_SAVE_ALL_CALLEE_SAVE_FRAME_OFFSET),
            facebook::museum::MUSEUM_VERSION::art::Runtime::GetCalleeSaveMethodOffset(facebook::museum::MUSEUM_VERSION::art::Runtime::kSaveAll))
...
ADD_TEST_EQ(static_cast<size_t>(RUNTIME_REFS_ONLY_CALLEE_SAVE_FRAME_OFFSET),
            facebook::museum::MUSEUM_VERSION::art::Runtime::GetCalleeSaveMethodOffset(facebook::museum::MUSEUM_VERSION::art::Runtime::kRefsOnly))
...
ADD_TEST_EQ(static_cast<size_t>(RUNTIME_REFS_AND_ARGS_CALLEE_SAVE_FRAME_OFFSET),
            facebook::museum::MUSEUM_VERSION::art::Runtime::GetCalleeSaveMethodOffset(facebook::museum::MUSEUM_VERSION::art::Runtime::kRefsAndArgs))

// Offset of field Thread::tls32_.state_and_flags.
#define THREAD_FLAGS_OFFSET 0
ADD_TEST_EQ(THREAD_FLAGS_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::ThreadFlagsOffset<__SIZEOF_POINTER__>().Int32Value())

// Offset of field Thread::tls32_.thin_lock_thread_id.
#define THREAD_ID_OFFSET 12
ADD_TEST_EQ(THREAD_ID_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::ThinLockIdOffset<__SIZEOF_POINTER__>().Int32Value())

// Offset of field Thread::tls32_.is_gc_marking.
#define THREAD_IS_GC_MARKING_OFFSET 52
ADD_TEST_EQ(THREAD_IS_GC_MARKING_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::IsGcMarkingOffset<__SIZEOF_POINTER__>().Int32Value())

// Offset of field Thread::tlsPtr_.card_table.
#define THREAD_CARD_TABLE_OFFSET 128
ADD_TEST_EQ(THREAD_CARD_TABLE_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::CardTableOffset<__SIZEOF_POINTER__>().Int32Value())
...
ADD_TEST_EQ(THREAD_EXCEPTION_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::ExceptionOffset<__SIZEOF_POINTER__>().Int32Value())
...
ADD_TEST_EQ(THREAD_TOP_QUICK_FRAME_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::TopOfManagedStackOffset<__SIZEOF_POINTER__>().Int32Value())

// Offset of field Thread::tlsPtr_.self.
#define THREAD_SELF_OFFSET (THREAD_CARD_TABLE_OFFSET + (9 * __SIZEOF_POINTER__))
ADD_TEST_EQ(THREAD_SELF_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::SelfOffset<__SIZEOF_POINTER__>().Int32Value())

// Offset of field Thread::tlsPtr_.thread_local_objects.
#define THREAD_LOCAL_OBJECTS_OFFSET (THREAD_CARD_TABLE_OFFSET + 168 * __SIZEOF_POINTER__)
ADD_TEST_EQ(THREAD_LOCAL_OBJECTS_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::ThreadLocalObjectsOffset<__SIZEOF_POINTER__>().Int32Value())
// Offset of field Thread::tlsPtr_.thread_local_pos.
#define THREAD_LOCAL_POS_OFFSET (THREAD_LOCAL_OBJECTS_OFFSET + 2 * __SIZEOF_POINTER__)
ADD_TEST_EQ(THREAD_LOCAL_POS_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::ThreadLocalPosOffset<__SIZEOF_POINTER__>().Int32Value())
// Offset of field Thread::tlsPtr_.thread_local_end.
#define THREAD_LOCAL_END_OFFSET (THREAD_LOCAL_POS_OFFSET + __SIZEOF_POINTER__)
ADD_TEST_EQ(THREAD_LOCAL_END_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::ThreadLocalEndOffset<__SIZEOF_POINTER__>().Int32Value())
// Offset of field Thread::tlsPtr_.mterp_current_ibase.
#define THREAD_CURRENT_IBASE_OFFSET (THREAD_LOCAL_POS_OFFSET + 2 * __SIZEOF_POINTER__)
ADD_TEST_EQ(THREAD_CURRENT_IBASE_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::MterpCurrentIBaseOffset<__SIZEOF_POINTER__>().Int32Value())
...
ADD_TEST_EQ(THREAD_DEFAULT_IBASE_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::MterpDefaultIBaseOffset<__SIZEOF_POINTER__>().Int32Value())
...
ADD_TEST_EQ(THREAD_ALT_IBASE_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::MterpAltIBaseOffset<__SIZEOF_POINTER__>().Int32Value())
...
ADD_TEST_EQ(THREAD_ROSALLOC_RUNS_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::RosAllocRunsOffset<__SIZEOF_POINTER__>().Int32Value())
...
ADD_TEST_EQ(THREAD_LOCAL_ALLOC_STACK_TOP_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::ThreadLocalAllocStackTopOffset<__SIZEOF_POINTER__>().Int32Value())
...
ADD_TEST_EQ(THREAD_LOCAL_ALLOC_STACK_END_OFFSET,
            facebook::museum::MUSEUM_VERSION::art::Thread::ThreadLocalAllocStackEndOffset<__SIZEOF_POINTER__>().Int32Value())
...
ADD_TEST_EQ(CODEITEM_INSNS_OFFSET,
            static_cast<int32_t>(OFFSETOF_MEMBER(facebook::museum::MUSEUM_VERSION::art::DexFile::CodeItem, insns_)))

// Offsets within java.lang.Object.
#define MIRROR_OBJECT_CLASS_OFFSET 0
ADD_TEST_EQ(MIRROR_OBJECT_CLASS_OFFSET, facebook::museum::MUSEUM_VERSION::art::mirror::Object::ClassOffset().Int32Value())
#define MIRROR_OBJECT_LOCK_WORD_OFFSET 4
ADD_TEST_EQ(MIRROR_OBJECT_LOCK_WORD_OFFSET, facebook::museum::MUSEUM_VERSION::art::mirror::Object::MonitorOffset().Int32Value())
...
ADD_TEST_EQ(static_cast<uint32_t>(MIRROR_CLASS_STATUS_INITIALIZED),
            static_cast<uint32_t>(facebook::museum::MUSEUM_VERSION::art::mirror::Class::kStatusInitialized))
#define ACCESS_FLAGS_CLASS_IS_FINALIZABLE 0x80000000
ADD_TEST_EQ(static_cast<uint32_t>(ACCESS_FLAGS_CLASS_IS_FINALIZABLE),
            static_cast<uint32_t>(facebook::museum::MUSEUM_VERSION::art::kAccClassIsFinalizable))
...
ADD_TEST_EQ(ART_METHOD_DEX_CACHE_METHODS_OFFSET_32,
            facebook::museum::MUSEUM_VERSION::art::ArtMethod::DexCacheResolvedMethodsOffset(4).Int32Value())

#define ART_METHOD_DEX_CACHE_METHODS_OFFSET_64 24
ADD_TEST_EQ(ART_METHOD_DEX_CACHE_METHODS_OFFSET_64,
            facebook::museum::MUSEUM_VERSION::art::ArtMethod::DexCacheResolvedMethodsOffset(8).Int32Value())

#define ART_METHOD_DEX_CACHE_TYPES_OFFSET_32 24
ADD_TEST_EQ(ART_METHOD_DEX_CACHE_TYPES_OFFSET_32,
            facebook::museum::MUSEUM_VERSION::art::ArtMethod::DexCacheResolvedTypesOffset(4).Int32Value())

#define ART_METHOD_DEX_CACHE_TYPES_OFFSET_64 32
ADD_TEST_EQ(ART_METHOD_DEX_CACHE_TYPES_OFFSET_64,
            facebook::museum::MUSEUM_VERSION::art::ArtMethod::DexCacheResolvedTypesOffset(8).Int32Value())

#define ART_METHOD_JNI_OFFSET_32 28
ADD_TEST_EQ(ART_METHOD_JNI_OFFSET_32,
            facebook::museum::MUSEUM_VERSION::art::ArtMethod::EntryPointFromJniOffset(4).Int32Value())

#define ART_METHOD_JNI_OFFSET_64 40
ADD_TEST_EQ(ART_METHOD_JNI_OFFSET_64,
            facebook::museum::MUSEUM_VERSION::art::ArtMethod::EntryPointFromJniOffset(8).Int32Value())

#define ART_METHOD_QUICK_CODE_OFFSET_32 32
ADD_TEST_EQ(ART_METHOD_QUICK_CODE_OFFSET_32,
            facebook::museum::MUSEUM_VERSION::art::ArtMethod::EntryPointFromQuickCompiledCodeOffset(4).Int32Value())

#define ART_METHOD_QUICK_CODE_OFFSET_64 48
ADD_TEST_EQ(ART_METHOD_QUICK_CODE_OFFSET_64,
            facebook::museum::MUSEUM_VERSION::art::ArtMethod::EntryPointFromQuickCompiledCodeOffset(8).Int32Value())

#define LOCK_WORD_STATE_SHIFT 30
ADD_TEST_EQ(LOCK_WORD_STATE_SHIFT, static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::LockWord::kStateShift))

#define LOCK_WORD_STATE_MASK 0xC0000000
ADD_TEST_EQ(LOCK_WORD_STATE_MASK, static_cast<uint32_t>(facebook::museum::MUSEUM_VERSION::art::LockWord::kStateMaskShifted))

#define LOCK_WORD_READ_BARRIER_STATE_SHIFT 28
ADD_TEST_EQ(LOCK_WORD_READ_BARRIER_STATE_SHIFT,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::LockWord::kReadBarrierStateShift))

#define LOCK_WORD_READ_BARRIER_STATE_MASK 0x30000000
ADD_TEST_EQ(LOCK_WORD_READ_BARRIER_STATE_MASK,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::LockWord::kReadBarrierStateMaskShifted))

#define LOCK_WORD_READ_BARRIER_STATE_MASK_TOGGLED 0xCFFFFFFF
ADD_TEST_EQ(LOCK_WORD_READ_BARRIER_STATE_MASK_TOGGLED,
            static_cast<uint32_t>(facebook::museum::MUSEUM_VERSION::art::LockWord::kReadBarrierStateMaskShiftedToggled))

#define LOCK_WORD_THIN_LOCK_COUNT_ONE 65536
ADD_TEST_EQ(LOCK_WORD_THIN_LOCK_COUNT_ONE, static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::LockWord::kThinLockCountOne))

#define OBJECT_ALIGNMENT_MASK 7
ADD_TEST_EQ(static_cast<size_t>(OBJECT_ALIGNMENT_MASK), facebook::museum::MUSEUM_VERSION::art::kObjectAlignment - 1)

#define OBJECT_ALIGNMENT_MASK_TOGGLED 0xFFFFFFF8
ADD_TEST_EQ(static_cast<uint32_t>(OBJECT_ALIGNMENT_MASK_TOGGLED),
            ~static_cast<uint32_t>(facebook::museum::MUSEUM_VERSION::art::kObjectAlignment - 1))

#define ROSALLOC_MAX_THREAD_LOCAL_BRACKET_SIZE 128
ADD_TEST_EQ(ROSALLOC_MAX_THREAD_LOCAL_BRACKET_SIZE,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::gc::allocator::RosAlloc::kMaxThreadLocalBracketSize))

#define ROSALLOC_BRACKET_QUANTUM_SIZE_SHIFT 3
ADD_TEST_EQ(ROSALLOC_BRACKET_QUANTUM_SIZE_SHIFT,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::gc::allocator::RosAlloc::kThreadLocalBracketQuantumSizeShift))

#define ROSALLOC_BRACKET_QUANTUM_SIZE_MASK 7
ADD_TEST_EQ(ROSALLOC_BRACKET_QUANTUM_SIZE_MASK,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::gc::allocator::RosAlloc::kThreadLocalBracketQuantumSize - 1))
...
ADD_TEST_EQ(static_cast<uint32_t>(ROSALLOC_BRACKET_QUANTUM_SIZE_MASK_TOGGLED32),
            ~static_cast<uint32_t>(
                facebook::museum::MUSEUM_VERSION::art::gc::allocator::RosAlloc::kThreadLocalBracketQuantumSize - 1))
...
ADD_TEST_EQ(ROSALLOC_RUN_FREE_LIST_OFFSET,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::gc::allocator::RosAlloc::RunFreeListOffset()))

#define ROSALLOC_RUN_FREE_LIST_HEAD_OFFSET 0
ADD_TEST_EQ(ROSALLOC_RUN_FREE_LIST_HEAD_OFFSET,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::gc::allocator::RosAlloc::RunFreeListHeadOffset()))

#define ROSALLOC_RUN_FREE_LIST_SIZE_OFFSET 16
ADD_TEST_EQ(ROSALLOC_RUN_FREE_LIST_SIZE_OFFSET,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::gc::allocator::RosAlloc::RunFreeListSizeOffset()))

#define ROSALLOC_SLOT_NEXT_OFFSET 0
ADD_TEST_EQ(ROSALLOC_SLOT_NEXT_OFFSET,
            static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::gc::allocator::RosAlloc::RunSlotNextOffset()))
...
ADD_TEST_EQ(THREAD_SUSPEND_REQUEST, static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::kSuspendRequest))

#define THREAD_CHECKPOINT_REQUEST 2
ADD_TEST_EQ(THREAD_CHECKPOINT_REQUEST, static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::kCheckpointRequest))

#define JIT_CHECK_OSR -1
ADD_TEST_EQ(JIT_CHECK_OSR, static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::jit::kJitCheckForOSR))

#define JIT_HOTNESS_DISABLE -2
ADD_TEST_EQ(JIT_HOTNESS_DISABLE, static_cast<int32_t>(facebook::museum::MUSEUM_VERSION::art::jit::kJitHotnessDisabled))
