...
#include <museum/7.1.2/art/runtime/arch/mips64/registers_mips64.h>
...
constexpr uint32_t Mips64CalleeSaveCoreSpills(Runtime::CalleeSaveType type) {
  return kMips64CalleeSaveRefSpills |
      ...
      (type == Runtime::kSaveAll ? kMips64CalleeSaveAllSpills : 0) | (1 << facebook::museum::MUSEUM_VERSION::art::mips64::RA);
}
