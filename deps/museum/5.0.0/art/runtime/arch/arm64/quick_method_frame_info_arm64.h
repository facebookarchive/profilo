...
#include <museum/5.0.0/art/runtime/arch/arm64/registers_arm64.h>
#include <museum/5.0.0/art/runtime/runtime.h>  // for Runtime::CalleeSaveType.
#include <museum/5.0.0/art/runtime/utils.h>  // for POPCOUNT
...
static constexpr uint32_t kArm64CalleeSaveAllSpills =
    // Thread register.
    (1 << facebook::museum::MUSEUM_VERSION::art::arm64::X18) |
    // Suspend register.
