...
inline _MUSEUM_LIBCPP_ALWAYS_INLINE float strtof_l(const char *nptr,
                                            char **endptr, locale_t) {
  return ::strtof(nptr, endptr);
}

inline _MUSEUM_LIBCPP_ALWAYS_INLINE double strtod_l(const char *nptr,
                                                   char **endptr, locale_t) {
  return ::strtod(nptr, endptr);
}

inline _MUSEUM_LIBCPP_ALWAYS_INLINE long double strtold_l(const char *nptr,
                                                   char **endptr, locale_t) {
  return ::strtold(nptr, endptr);
}

inline _MUSEUM_LIBCPP_ALWAYS_INLINE long long
strtoll_l(const char *nptr, char **endptr, int base, locale_t) {
  return ::strtoll(nptr, endptr, base);
}

inline _MUSEUM_LIBCPP_ALWAYS_INLINE unsigned long long
...
inline _MUSEUM_LIBCPP_ALWAYS_INLINE long double wcstold_l(const wchar_t *nptr,
