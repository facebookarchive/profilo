...
class ArtClassDefinition {
 public:
  ...
  facebook::museum::MUSEUM_VERSION::art::ArraySlice<const unsigned char> GetNewOriginalDexFile() const {
    DCHECK(IsInitialized());
    if (redefined_) {
      return original_dex_file_;
    } else {
      return facebook::museum::MUSEUM_VERSION::art::ArraySlice<const unsigned char>();
    }
  }
  ...
  facebook::museum::MUSEUM_VERSION::art::ArraySlice<const unsigned char> GetDexData() const {
    DCHECK(IsInitialized());
    return facebook::museum::MUSEUM_VERSION::art::ArraySlice<const unsigned char>(dex_data_.get(), dex_len_);
  }
