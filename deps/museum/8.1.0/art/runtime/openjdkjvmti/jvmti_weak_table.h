...
class JvmtiWeakTable : public facebook::museum::MUSEUM_VERSION::art::gc::SystemWeakHolder {
 public:
  ...
  // value).
  ALWAYS_INLINE bool Remove(facebook::museum::MUSEUM_VERSION::art::mirror::Object* obj, /* out */ T* tag)
      REQUIRES_SHARED(facebook::museum::MUSEUM_VERSION::art::Locks::mutator_lock_)
      REQUIRES(!allow_disallow_lock_);
  ALWAYS_INLINE bool RemoveLocked(facebook::museum::MUSEUM_VERSION::art::mirror::Object* obj, /* out */ T* tag)
      REQUIRES_SHARED(facebook::museum::MUSEUM_VERSION::art::Locks::mutator_lock_)
      REQUIRES(allow_disallow_lock_);

  // Set the mapping for the given object. Returns true if this overwrites an already existing
  // mapping.
  ALWAYS_INLINE virtual bool Set(facebook::museum::MUSEUM_VERSION::art::mirror::Object* obj, T tag)
      REQUIRES_SHARED(facebook::museum::MUSEUM_VERSION::art::Locks::mutator_lock_)
      REQUIRES(!allow_disallow_lock_);
  ALWAYS_INLINE virtual bool SetLocked(facebook::museum::MUSEUM_VERSION::art::mirror::Object* obj, T tag)
      REQUIRES_SHARED(facebook::museum::MUSEUM_VERSION::art::Locks::mutator_lock_)
      REQUIRES(allow_disallow_lock_);
  ...
  ALWAYS_INLINE void Sweep(facebook::museum::MUSEUM_VERSION::art::IsMarkedVisitor* visitor)
      REQUIRES_SHARED(facebook::museum::MUSEUM_VERSION::art::Locks::mutator_lock_)
      REQUIRES(!allow_disallow_lock_);
  ...
  ALWAYS_INLINE facebook::museum::MUSEUM_VERSION::art::mirror::Object* Find(T tag)
      REQUIRES_SHARED(facebook::museum::MUSEUM_VERSION::art::Locks::mutator_lock_)
      REQUIRES(!allow_disallow_lock_);
 ...
 private:
  ...
  using TagAllocator = JvmtiAllocator<std::pair<const facebook::museum::MUSEUM_VERSION::art::GcRoot<facebook::museum::MUSEUM_VERSION::art::mirror::Object>, T>>;
