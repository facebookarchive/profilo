...
#include <museum/8.1.0/art/runtime/jni_env_ext-inl.h>
#include "jvmti.h"
#include <museum/8.1.0/art/runtime/linear_alloc.h>
...
#include <museum/8.1.0/art/runtime/openjdkjvmti/ti_class_definition.h>
#include <museum/8.1.0/art/runtime/thread_list.h>
#include <museum/8.1.0/art/runtime/openjdkjvmti/transform.h>
#include <museum/8.1.0/art/runtime/utf.h>
#include <museum/8.1.0/art/runtime/utils/dex_cache_arrays_layout-inl.h>
...
class Redefiner {
 public:
  ...
  static std::unique_ptr<facebook::museum::MUSEUM_VERSION::art::MemMap> MoveDataToMemMap(const std::string& original_location,
                                                       facebook::museum::MUSEUM_VERSION::art::ArrayRef<const unsigned char> data,
  ...
  class ClassRedefinition {
   public:
    ClassRedefinition(Redefiner* driver,
                      ...
                      facebook::museum::MUSEUM_VERSION::art::ArrayRef<const unsigned char> orig_dex_file)
    ...
    void UnregisterJvmtiBreakpoints() REQUIRES(facebook::museum::MUSEUM_VERSION::art::Locks::mutator_lock_);
