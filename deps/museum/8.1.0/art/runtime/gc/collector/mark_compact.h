...
#include <museum/8.1.0/external/libcxx/memory>  // For unique_ptr.
...
#include <museum/8.1.0/art/runtime/gc/collector/garbage_collector.h>
#include <museum/8.1.0/art/runtime/gc_root.h>
#include <museum/8.1.0/art/runtime/gc/accounting/heap_bitmap.h>
