...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_FUTEX_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_FUTEX_H_
#define NDK_ANDROID_SUPPORT_LINUX_FUTEX_H
#define NDK_ANDROID_SUPPORT_LINUX_FUTEX_H_
