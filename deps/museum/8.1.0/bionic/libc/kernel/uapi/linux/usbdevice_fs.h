...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_USBDEVICE_FS_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_USBDEVICE_FS_H_
#define NDK_ANDROID_SUPPORT_LINUX_USBDEVICE_FS_H
#define NDK_ANDROID_SUPPORT_LINUX_USBDEVICE_FS_H_
