...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_VT_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_VT_H_
#define NDK_ANDROID_SUPPORT_LINUX_VT_H
#define NDK_ANDROID_SUPPORT_LINUX_VT_H_
#define _LINUX_VT_H
#define _LINUX_VT_H_
