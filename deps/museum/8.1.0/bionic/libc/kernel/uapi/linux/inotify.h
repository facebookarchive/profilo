...
#define UAPI_LINUX_INOTIFY_H
#define UAPI_LINUX_INOTIFY_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_INOTIFY_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_INOTIFY_H_
#define NDK_ANDROID_SUPPORT_LINUX_INOTIFY_H
#define NDK_ANDROID_SUPPORT_LINUX_INOTIFY_H_
#define _LINUX_INOTIFY_H
#define _LINUX_INOTIFY_H_
#define _UAPI_LINUX_INOTIFY_H_
