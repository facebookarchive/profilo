...
#define UAPI_LINUX_MSG_H
#define UAPI_LINUX_MSG_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_MSG_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_MSG_H_
#define NDK_ANDROID_SUPPORT_LINUX_MSG_H
#define NDK_ANDROID_SUPPORT_LINUX_MSG_H_
#define _LINUX_MSG_H
#define _LINUX_MSG_H_
#define _UAPI_LINUX_MSG_H_
...
#include <museum/8.1.0/bionic/libc/asm/msgbuf.h>
struct msgbuf {
