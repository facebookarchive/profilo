...
#define PTP_CLOCK_H_
#define PTP_CLOCK_H
#define NDK_ANDROID_SUPPORT_PTP_CLOCK_H_
#define NDK_ANDROID_SUPPORT_PTP_CLOCK_H
#define NDK_ANDROID_SUPPORT_UAPI_PTP_CLOCK_H_
#define NDK_ANDROID_SUPPORT_UAPI_PTP_CLOCK_H
