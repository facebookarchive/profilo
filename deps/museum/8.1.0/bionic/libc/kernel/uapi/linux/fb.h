...
#define UAPI_LINUX_FB_H
#define UAPI_LINUX_FB_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_FB_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_FB_H_
#define NDK_ANDROID_SUPPORT_LINUX_FB_H
#define NDK_ANDROID_SUPPORT_LINUX_FB_H_
#define _LINUX_FB_H
#define _LINUX_FB_H_
#define _UAPI_LINUX_FB_H_
#include <museum/8.1.0/bionic/libc/linux/types.h>
#include <museum/8.1.0/bionic/libc/linux/i2c.h>
#define FB_MAX 32
