...
#define NDK_ANDROID_SUPPORT_VIRTIO_CRYPTO_H
#define NDK_ANDROID_SUPPORT_VIRTIO_CRYPTO_H_
#define NDK_ANDROID_SUPPORT_UAPI_VIRTIO_CRYPTO_H
#define NDK_ANDROID_SUPPORT_UAPI_VIRTIO_CRYPTO_H_
