...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_SECUREBITS_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_SECUREBITS_H_
#define NDK_ANDROID_SUPPORT_LINUX_SECUREBITS_H
#define NDK_ANDROID_SUPPORT_LINUX_SECUREBITS_H_
