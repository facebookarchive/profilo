...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_ISDN_DIVERTIF_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_ISDN_DIVERTIF_H_
#define NDK_ANDROID_SUPPORT_LINUX_ISDN_DIVERTIF_H
#define NDK_ANDROID_SUPPORT_LINUX_ISDN_DIVERTIF_H_
