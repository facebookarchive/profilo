...
#define NDK_ANDROID_SUPPORT_LINUX_ATMSVC_H
#define NDK_ANDROID_SUPPORT_LINUX_ATMSVC_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_ATMSVC_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_ATMSVC_H_
