...
#define NDK_ANDROID_SUPPORT_UAPI_NFNL_ACCT_H_
#define NDK_ANDROID_SUPPORT_UAPI_NFNL_ACCT_H
#define NDK_ANDROID_SUPPORT_NFNL_ACCT_H_
#define NDK_ANDROID_SUPPORT_NFNL_ACCT_H
