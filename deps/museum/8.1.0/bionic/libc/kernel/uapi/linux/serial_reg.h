...
#define NDK_ANDROID_SUPPORT_LINUX_SERIAL_REG_H
#define NDK_ANDROID_SUPPORT_LINUX_SERIAL_REG_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_SERIAL_REG_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_SERIAL_REG_H_
