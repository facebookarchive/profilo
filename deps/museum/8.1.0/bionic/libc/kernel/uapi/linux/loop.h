...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_LOOP_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_LOOP_H_
#define NDK_ANDROID_SUPPORT_LINUX_LOOP_H
#define NDK_ANDROID_SUPPORT_LINUX_LOOP_H_
