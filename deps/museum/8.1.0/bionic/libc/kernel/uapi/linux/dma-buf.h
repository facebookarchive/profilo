...
#define NDK_ANDROID_SUPPORT_DMA_BUF_UAPI_H_
#define NDK_ANDROID_SUPPORT_DMA_BUF_UAPI_H
#define NDK_ANDROID_SUPPORT_UAPI_DMA_BUF_UAPI_H_
#define NDK_ANDROID_SUPPORT_UAPI_DMA_BUF_UAPI_H
