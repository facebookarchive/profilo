...
#define NDK_ANDROID_SUPPORT__LINUX_USB_TMC_H
#define NDK_ANDROID_SUPPORT__LINUX_USB_TMC_H_
#define NDK_ANDROID_SUPPORT_UAPI__LINUX_USB_TMC_H
#define NDK_ANDROID_SUPPORT_UAPI__LINUX_USB_TMC_H_
