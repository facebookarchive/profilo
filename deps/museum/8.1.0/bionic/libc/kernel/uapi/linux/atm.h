...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_ATM_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_ATM_H_
#define NDK_ANDROID_SUPPORT_LINUX_ATM_H
#define NDK_ANDROID_SUPPORT_LINUX_ATM_H_
#define _LINUX_ATM_H
