...
#define PPP_IOCTL_H
#define PPP_IOCTL_H_
#define NDK_ANDROID_SUPPORT_PPP_IOCTL_H
#define NDK_ANDROID_SUPPORT_PPP_IOCTL_H_
#define NDK_ANDROID_SUPPORT_UAPI_PPP_IOCTL_H
#define NDK_ANDROID_SUPPORT_UAPI_PPP_IOCTL_H_
