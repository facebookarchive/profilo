...
#define ULTRASOUND_H
#define NDK_ANDROID_SUPPORT_ULTRASOUND_H_
#define NDK_ANDROID_SUPPORT_ULTRASOUND_H
#define NDK_ANDROID_SUPPORT_UAPI_ULTRASOUND_H_
#define NDK_ANDROID_SUPPORT_UAPI_ULTRASOUND_H
