...
#define UAPI_LINUX_ETHTOOL_H
#define UAPI_LINUX_ETHTOOL_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_ETHTOOL_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_ETHTOOL_H_
#define NDK_ANDROID_SUPPORT_LINUX_ETHTOOL_H
#define NDK_ANDROID_SUPPORT_LINUX_ETHTOOL_H_
#define _LINUX_ETHTOOL_H
#define _LINUX_ETHTOOL_H_
#define _UAPI_LINUX_ETHTOOL_H_
