...
#define UAPI_LINUX_SWAB_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_SWAB_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_SWAB_H_
#define NDK_ANDROID_SUPPORT_LINUX_SWAB_H
#define NDK_ANDROID_SUPPORT_LINUX_SWAB_H_
#define _LINUX_SWAB_H
#define _LINUX_SWAB_H_
#define _UAPI_LINUX_SWAB_H_
#include <museum/8.1.0/bionic/libc/linux/types.h>
#include <linux/compiler.h>
#include <museum/8.1.0/bionic/libc/asm/swab.h>
