...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_VIRTIO_CONSOLE_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_VIRTIO_CONSOLE_H_
#define NDK_ANDROID_SUPPORT_LINUX_VIRTIO_CONSOLE_H
#define NDK_ANDROID_SUPPORT_LINUX_VIRTIO_CONSOLE_H_
