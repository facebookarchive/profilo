...
#define NDK_ANDROID_SUPPORT__LINUX_NSFS_H
#define NDK_ANDROID_SUPPORT__LINUX_NSFS_H_
#define NDK_ANDROID_SUPPORT_UAPI__LINUX_NSFS_H
#define NDK_ANDROID_SUPPORT_UAPI__LINUX_NSFS_H_
