...
#define LINUX_VHOST_H
#define LINUX_VHOST_H_
#define NDK_ANDROID_SUPPORT_LINUX_VHOST_H
#define NDK_ANDROID_SUPPORT_LINUX_VHOST_H_
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_VHOST_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_VHOST_H_
#define _UAPI_LINUX_VHOST_H
#define _UAPI_LINUX_VHOST_H_
#define _LINUX_VHOST_H_
