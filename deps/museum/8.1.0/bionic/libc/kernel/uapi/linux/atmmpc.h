...
#define ATMMPC_H_
#define ATMMPC_H
#define NDK_ANDROID_SUPPORT_ATMMPC_H_
#define NDK_ANDROID_SUPPORT_ATMMPC_H
#define NDK_ANDROID_SUPPORT_UAPI_ATMMPC_H_
#define NDK_ANDROID_SUPPORT_UAPI_ATMMPC_H
