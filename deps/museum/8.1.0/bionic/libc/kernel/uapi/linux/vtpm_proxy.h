...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_VTPM_PROXY_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_VTPM_PROXY_H_
#define NDK_ANDROID_SUPPORT_LINUX_VTPM_PROXY_H
#define NDK_ANDROID_SUPPORT_LINUX_VTPM_PROXY_H_
