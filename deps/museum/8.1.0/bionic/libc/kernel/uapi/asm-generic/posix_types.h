...
#define NDK_ANDROID_SUPPORT__ASM_GENERIC_POSIX_TYPES_H
#define NDK_ANDROID_SUPPORT__ASM_GENERIC_POSIX_TYPES_H_
#define NDK_ANDROID_SUPPORT_UAPI__ASM_GENERIC_POSIX_TYPES_H
#define NDK_ANDROID_SUPPORT_UAPI__ASM_GENERIC_POSIX_TYPES_H_
