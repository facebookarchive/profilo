...
#define NDK_ANDROID_SUPPORT__ASM_GENERIC_STAT_H
#define NDK_ANDROID_SUPPORT__ASM_GENERIC_STAT_H_
#define NDK_ANDROID_SUPPORT_UAPI__ASM_GENERIC_STAT_H
#define NDK_ANDROID_SUPPORT_UAPI__ASM_GENERIC_STAT_H_
