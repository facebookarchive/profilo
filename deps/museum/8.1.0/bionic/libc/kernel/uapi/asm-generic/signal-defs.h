...
#define NDK_ANDROID_SUPPORT__ASM_GENERIC_SIGNAL_DEFS_H
#define NDK_ANDROID_SUPPORT__ASM_GENERIC_SIGNAL_DEFS_H_
#define NDK_ANDROID_SUPPORT_UAPI__ASM_GENERIC_SIGNAL_DEFS_H
#define NDK_ANDROID_SUPPORT_UAPI__ASM_GENERIC_SIGNAL_DEFS_H_
