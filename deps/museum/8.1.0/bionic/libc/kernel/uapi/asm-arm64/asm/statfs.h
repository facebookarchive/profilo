...
#define NDK_ANDROID_SUPPORT__ASM_STATFS_H
#define NDK_ANDROID_SUPPORT__ASM_STATFS_H_
#define NDK_ANDROID_SUPPORT_UAPI__ASM_STATFS_H
#define NDK_ANDROID_SUPPORT_UAPI__ASM_STATFS_H_
