...
#define NDK_ANDROID_SUPPORT_UAPI__ASM_PTRACE_H
#define NDK_ANDROID_SUPPORT_UAPI__ASM_PTRACE_H_
#define NDK_ANDROID_SUPPORT__ASM_PTRACE_H
#define NDK_ANDROID_SUPPORT__ASM_PTRACE_H_
