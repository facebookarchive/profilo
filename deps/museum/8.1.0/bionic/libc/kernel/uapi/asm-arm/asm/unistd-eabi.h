...
#define NDK_ANDROID_SUPPORT_UAPI_ASM_ARM_UNISTD_EABI_H
#define NDK_ANDROID_SUPPORT_UAPI_ASM_ARM_UNISTD_EABI_H_
#define NDK_ANDROID_SUPPORT_ASM_ARM_UNISTD_EABI_H
#define NDK_ANDROID_SUPPORT_ASM_ARM_UNISTD_EABI_H_
