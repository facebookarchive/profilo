...
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_COMPILER_H
#define NDK_ANDROID_SUPPORT_UAPI_LINUX_COMPILER_H_
#define NDK_ANDROID_SUPPORT_LINUX_COMPILER_H
#define NDK_ANDROID_SUPPORT_LINUX_COMPILER_H_
