...
// @generated SignedSource<<8076c74fe118ccc3f7b67c09ac9a7ada>>
// @model md5 e48a5264d666d874913d8dfa0e56d050
...
namespace art {
  ...
  mirror::Class* ClassLinker::LookupClass(char const* p1, size_t p2, mirror::ClassLoader* p3)  {
    return
      ::facebook::museum::art::detail::lookup___ZN3art11ClassLinker11LookupClassEPKcjPNS_6mirror11ClassLoaderE
      <mirror::Class*
...
namespace art {
  ...
  mirror::Class* ClassLinker::FindClassInPathClassLoader(ScopedObjectAccessAlreadyRunnable& p1, Thread* p2, char const* p3, size_t p4, Handle<mirror::ClassLoader> p5)  {
    return
      ::facebook::museum::art::detail::lookup___ZN3art11ClassLinker26FindClassInPathClassLoaderERNS_33ScopedObjectAccessAlreadyRunnableEPNS_6ThreadEPKcjNS_6HandleINS_6mirror11ClassLoaderEEE
      <mirror::Class*
...
namespace art {
  ...
  ThrowLocation Thread::GetCurrentLocationForThrow()  {
    return
      ::facebook::museum::art::detail::lookup___ZN3art6Thread26GetCurrentLocationForThrowEv
      <ThrowLocation
        (Thread *)>()
      (this);
  }
...
namespace art {
  ...
  mirror::Object* StackVisitor::GetThisObject() const {
    return
      ::facebook::museum::art::detail::lookup___ZNK3art12StackVisitor13GetThisObjectEv
      <mirror::Object*
        (StackVisitor const*)>()
      (this);
  }
...
namespace art {
  ...
  pid_t GetTid()  {
    return
      ::facebook::museum::art::detail::lookup___ZN3art6GetTidEv
      <pid_t
        ()>()
      ();
  }
...
namespace art {
  ...
  std::ostream& operator<<(std::ostream& p1, ThreadState const& p2)  {
    return
      ::facebook::museum::art::detail::lookup___ZN3artlsERNSt3__113basic_ostreamIcNS0_11char_traitsIcEEEERKNS_11ThreadStateE
      <std::ostream&
