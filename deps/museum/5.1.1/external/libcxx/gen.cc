...
// @generated SignedSource<<c87d89b8c75d38c1a1c2767c2658f4e9>>
// @model md5 eff7eaed7e9c9e0fe98a64ea0f1ee086


#include <museum/5.1.1/external/libcxx/exception>
#include <museum/5.1.1/external/libcxx/ios>
#include <museum/5.1.1/external/libcxx/locale>
#include <museum/5.1.1/external/libcxx/new>
#include <museum/5.1.1/external/libcxx/stdexcept>
...
namespace libcxx { namespace lookups {
  template<typename T>
  T* lookup___ZNSt3__16localeC1Ev() {
    static auto const symbol = ::facebook::libcxx().get_symbol<T>({
...
namespace std { inline namespace __1 { 
   ...
   locale::locale()   {
      ...
      ::facebook::museum::MUSEUM_VERSION::libcxx::lookups::lookup___ZNSt3__16localeC1Ev
      <void
        (locale *)>()
      (this);
...
namespace libcxx { namespace lookups {
  template<typename T>
  T* lookup___ZNSt3__18ios_base4initEPv() {
    static auto const symbol = ::facebook::libcxx().get_symbol<T>({
...
namespace std { inline namespace __1 { 
  ...
  void ios_base::init(void* p1)   {
    
      ::facebook::museum::MUSEUM_VERSION::libcxx::lookups::lookup___ZNSt3__18ios_base4initEPv
      <void
        (ios_base *, void*)>()
      (this, p1);
