...
class Runtime {
 ...
 private:
  ...
  std::string compiler_executable_; char junk_compiler_executable_[8];
  std::string patchoat_executable_; char junk_patchoat_executable_[8];
  std::vector<std::string> compiler_options_;
  std::vector<std::string> image_compiler_options_;
  std::string image_location_; char junk_image_location_[8];

  std::string boot_class_path_string_; char junk_boot_class_path_string_[8];
  std::string class_path_string_; char junk_class_path_string_[8];
  ...
  std::string stack_trace_file_; char junk_stack_trace_file_[8];
  ...
  std::string fault_message_ GUARDED_BY(fault_message_lock_); char junk_fault_message_[8];
  ...
  std::string profile_output_filename_; char junk_profile_output_filename_[8];
  ...
  std::string fingerprint_; char junk_fingerprint_[8];
