...
#include <museum/7.0.0/libnativehelper/ScopedLocalRef.h>
...
struct VectorCounter {
    const facebook::museum::MUSEUM_VERSION::std::vector<std::string>& strings;
    VectorCounter(const facebook::museum::MUSEUM_VERSION::std::vector<std::string>& strings) : strings(strings) {}
    size_t operator()() {
        return strings.size();
    }
};
struct VectorGetter {
    const facebook::museum::MUSEUM_VERSION::std::vector<std::string>& strings;
    VectorGetter(const facebook::museum::MUSEUM_VERSION::std::vector<std::string>& strings) : strings(strings) {}
    const char* operator()(size_t i) {
        return strings[i].c_str();
    }
};

inline jobjectArray toStringArray(JNIEnv* env, const facebook::museum::MUSEUM_VERSION::std::vector<std::string>& strings) {
