...
auto is_quick_resolution_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  ...
  return ((Read4(AccessField(class_linker, 272U)) == entry_point) || (Read4(AccessField(entry_points, 252U)) == entry_point));
}
...
auto is_quick_to_interpreter_bridge(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 212U));
  uintptr_t entry_points = AccessField(AccessField(thread, 120U), 160U);
  return ((Read4(AccessField(class_linker, 288U)) == entry_point) || (Read4(AccessField(entry_points, 256U)) == entry_point));
}
...
auto is_quick_generic_jni_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 212U));
  uintptr_t entry_points = AccessField(AccessField(thread, 120U), 160U);
  return ((Read4(AccessField(class_linker, 284U)) == entry_point) || (Read4(AccessField(entry_points, 148U)) == entry_point));
}
