...
{
  uint32_t access_flags = Read4(AccessField(method, 56U));
  return access_flags;
}
...
{
  uint32_t class_linker = Read4(AccessField(runtime, 208U));
  uintptr_t entry_points = AccessField(AccessField(thread, 120U), 160U);
  return ((Read4(AccessField(class_linker, 212U)) == entry_point) || (Read4(AccessField(entry_points, 252U)) == entry_point));
}
...
auto is_quick_to_interpreter_bridge(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 208U));
  uintptr_t entry_points = AccessField(AccessField(thread, 120U), 160U);
  return ((Read4(AccessField(class_linker, 228U)) == entry_point) || (Read4(AccessField(entry_points, 256U)) == entry_point));
}
...
auto is_quick_generic_jni_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 208U));
  uintptr_t entry_points = AccessField(AccessField(thread, 120U), 160U);
  return ((Read4(AccessField(class_linker, 224U)) == entry_point) || (Read4(AccessField(entry_points, 148U)) == entry_point));
}

auto get_quick_entry_point_from_compiled_code(uintptr_t method)
{
  uint64_t entry_point = Read8(AccessField(method, 40U));
...
auto unwind(unwind_callback_t __unwind_callback, void* __unwind_data)
{
  ...
  uint32_t generic_jni_trampoline = Read4(AccessField(AccessField(tls, 160U), 148U));
  while((mstack != 0U)){
