...
auto is_quick_resolution_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  ...
  return ((Read4(AccessField(class_linker, 240U)) == entry_point) || (Read4(AccessField(entry_points, 376U)) == entry_point));
}
...
auto is_quick_to_interpreter_bridge(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 284U));
  uintptr_t entry_points = AccessField(AccessField(thread, 128U), 156U);
  return ((Read4(AccessField(class_linker, 252U)) == entry_point) || (Read4(AccessField(entry_points, 380U)) == entry_point));
}
...
auto is_quick_generic_jni_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 284U));
  uintptr_t entry_points = AccessField(AccessField(thread, 128U), 156U);
  return ((Read4(AccessField(class_linker, 248U)) == entry_point) || (Read4(AccessField(entry_points, 204U)) == entry_point));
}
...
{
  uint32_t jit = Read4(AccessField(AccessField(AccessField(runtime, 308U), 0U), 0U));
...
auto get_oat_method(uintptr_t runtime_obj, struct OatClass const& struct_OatClass, uintptr_t oat_method_index)
{
  ...
  if((Read1(AccessField(oat_file, 40U)) || ((runtime_current == 0U) || runtime_is_aot_compiler(runtime_current, runtime_current)))){
...
auto get_code_offset(struct OatMethod const& struct_OatMethod)
{
  ...
  uint32_t method_header_size = 24U;
...
auto unwind(unwind_callback_t __unwind_callback, void* __unwind_data)
{
  ...
  uint32_t generic_jni_trampoline = Read4(AccessField(AccessField(tls, 156U), 204U));
  while((mstack != 0U)){
