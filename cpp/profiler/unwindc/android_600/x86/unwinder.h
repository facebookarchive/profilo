...
auto is_quick_resolution_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  ...
  return ((Read4(AccessField(class_linker, 284U)) == entry_point) || (Read4(AccessField(entry_points, 312U)) == entry_point));
}
...
auto is_quick_to_interpreter_bridge(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 236U));
  uintptr_t entry_points = AccessField(AccessField(thread, 128U), 136U);
  return ((Read4(AccessField(class_linker, 296U)) == entry_point) || (Read4(AccessField(entry_points, 316U)) == entry_point));
}
...
auto is_quick_generic_jni_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 236U));
  uintptr_t entry_points = AccessField(AccessField(thread, 128U), 136U);
  return ((Read4(AccessField(class_linker, 292U)) == entry_point) || (Read4(AccessField(entry_points, 208U)) == entry_point));
}
...
auto unwind(unwind_callback_t __unwind_callback, void* __unwind_data)
{
  ...
  uint32_t generic_jni_trampoline = Read4(AccessField(AccessField(tls, 136U), 208U));
  while((mstack != 0U)){
