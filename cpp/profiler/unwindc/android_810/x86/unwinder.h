...
auto is_quick_resolution_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  ...
  return ((Read4(AccessField(class_linker, 168U)) == entry_point) || (Read4(AccessField(entry_points, 376U)) == entry_point));
}
...
auto is_quick_to_interpreter_bridge(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 284U));
  uintptr_t entry_points = AccessField(AccessField(thread, 136U), 156U);
  return ((Read4(AccessField(class_linker, 180U)) == entry_point) || (Read4(AccessField(entry_points, 380U)) == entry_point));
}
...
auto is_quick_generic_jni_stub(uintptr_t entry_point, uintptr_t runtime, uintptr_t thread)
{
  uint32_t class_linker = Read4(AccessField(runtime, 284U));
  uintptr_t entry_points = AccessField(AccessField(thread, 136U), 156U);
  return ((Read4(AccessField(class_linker, 176U)) == entry_point) || (Read4(AccessField(entry_points, 204U)) == entry_point));
}
...
{
  uint32_t jit = Read4(AccessField(AccessField(AccessField(runtime, 312U), 0U), 0U));
