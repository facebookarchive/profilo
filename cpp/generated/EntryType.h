// @generated SignedSource<<d62e9e01c0499eca8ec109658c2280bc>>
...
enum class EntryType {
  ...
  STKERR_PARTIALSTACK = 93,
  STKERR_STACKCOPYFAILED = 94,
  STKERR_QUEUEOVERFLOW = 95,
  MAPPING = 96,
  LOGGER_PRIORITY = 97,
  CONDITIONAL_UPLOAD_RATE = 98,
  NATIVE_ALLOC = 99,
  NATIVE_FREE = 100,
  NATIVE_ALLOC_FAILURE = 101,
  NATIVE_STACK_FRAME = 102,
  MEMORY_MAPPED = 103,
  MEMORY_UNMAPPED = 104,
  ION_MEMORY_ALLOC = 105,
  ION_MEMORY_FREE = 106,
  ION_MEMORY_MAPPED = 107,
};
