...
public final class TraceConfigData implements Parcelable {
  ...
  public static final Parcelable.Creator<TraceConfigData> CREATOR =
      new Parcelable.Creator<TraceConfigData>() {
  ...
  public TraceConfigData(long configID, int traceTimeoutMs, int timedOutUploadSampleRate) {
